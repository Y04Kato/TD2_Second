...
void GroundManager::Initialize() {
	...
	ground_[1]->Initialize(groundModel_.get(), { 0.0f,-30.0f,0.0f }, { 20.0f,1.0f,5.0f });
	ground_[2]->Initialize(groundModel_.get(), { 0.0f,-30.0f,0.0f }, { 20.0f,1.0f,5.0f });
	ground_[3]->Initialize(groundModel_.get(), { 0.0f,-30.0f,0.0f }, { 20.0f,1.0f,5.0f });
}
